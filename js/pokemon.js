...
function changePokemon(cityName, pokemon){
    ...
    if (weatherText.includes("晴天")) {
      ...
      pokemonKing = "小火龍";
      bodyWrapper.style.backgroundColor = "rgba(255, 10, 10, 0.03)";
      aqiContainer.style.backgroundColor = "rgba(255, 10, 10, 0.03)";
      aqiContainer.style.transition = "background-color 0.7s";
      ...
      footer.style.transition = "background-color 1s";
        ...
        pokemon.style.display = "flex";
        pokemonKing = "梗鬼";
        bodyWrapper.style.backgroundColor = "rgba(128, 10, 128, 0.03)";
        bodyWrapper.style.transition = "background-color 0.7s";
        aqiContainer.style.backgroundColor = "rgba(128, 10, 128, 0.03)";
        aqiContainer.style.transition = "background-color 0.7s";
        ...
        pokemon.style.display = "flex";
        pokemonKing = "傑尼龜";
        bodyWrapper.style.backgroundColor = "rgba(173, 216, 230, 0.03)";
        bodyWrapper.style.transition = "background-color 0.7s";
        aqiContainer.style.backgroundColor = "rgba(173, 216, 230, 0.03)";
        aqiContainer.style.transition = "background-color 0.7s";
